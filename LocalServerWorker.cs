...
namespace LoadManager
{
	...
	//	private void FtpConnect(string fileUrl, string credentials, string filename)
	//	{
	...
	//		using (Stream readStream = downloadResponse.GetResponseStream())
		


	//		using (Stream targetStream = File.Create(filename))
	//		{
